...
const SunshineCloudsGD = preload("res://addons/SunshineClouds2/SunshineClouds.gd")
const SunshineCloudsEffector = preload("res://addons/SunshineClouds2/SunshineCloudEffector.gd")
